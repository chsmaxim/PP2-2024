...
while not done:
    screen.fill(colorWHITE)  # Clear the screen at the start of each frame
    ...
    snake.move()
    food = Food()  # Create a new food object inside the loop
    ...
    food.update_position(snake.body)  # Update food position after every frame
